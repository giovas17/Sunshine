...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "softwaremobility.darkgeat.sunshine.app";

    //Use CONTENT_AUTHORITY to create the base of all URI'swhich apps will use to contact
